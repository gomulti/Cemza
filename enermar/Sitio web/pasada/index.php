...
<html>
    ...
    <body>
    	<header class="Header u-size100-p u-imagenFondo u-textCenter"> 
            ...
            <div class="Header-video"><a id="mostrarPublicidad" href="video.html" class="u-ocultar u-inline-block fancyboxPublicidad fancybox.iframe Video-Watch">VER VIDEO</a></div>
				...
				<div class="Header-Barra u-size100-p fadeIn2">
            		...
            		<div class="Header-Center u-size-center u-textLeft">
                		<p class="Header-colMarine u-inline-block">
                    		<strong class="Header-TitleCol">DIESEL MARINO</strong>
							PRECIO ACTUAL:
							<span class="Header-Azul">$ <?php echo $precio;?></span>
						</p>

						<p class="Header-colClima">El precio cambia de acuerdo al tipo de cambio del precio del Dólar.</p>
                    -->
        ...
        <section class="About u-size100-p u-imagenFondo">
        	...
        	<article class="About-Center u-size-center u-desaparecer aparecerUp">
                ...
                <p class="About-Ibia"><strong>Somos miembros de <a href="http://ibia.net/" target="_blank">ibia.net</strong></a></p> 
        ...
        <section class="EstamosServirle u-size100-p u-imagenFondo">
        	<article class="EstamosServirle-Center u-size-center">
                ...
                <footer class="Footer u-textCenter">
         			&copy;  2015. Enermar Burkering Services. Todos los derechos reservados.  Diseño y desarrollo por <a href="http://www.gomultimedios.com/" target="_blank">GO multimedios.</a>        
        		</footer> 
            </article>
        </section>
