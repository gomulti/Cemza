...
$yourName = 'ENERMAR';
$yourEmail = 'ventas@enermar.com.mx';
$yourSubject = 'Mensaje desde sitio web';
$referringPage = 'http://www.enermar.com.mx/contacto.php';
...
return stripslashes($nStr);
	...
	$mailit = mail($to,$subject,$message,$headers);
		...
		if ( @$mailit )
		{ $posStatus = 'OK'; $posConfirmation = '¡Listo! Tu mensaje ha sido enviado correctamente'; }
		else
		{ $posStatus = 'NOTOK'; $posConfirmation = 'Tu mensaje no pudo ser enviado. Intentalo mas tarde'; }
