...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Enermar. BUNKERING SERVICES |</title>
    ...
    <body>
    	<header class="Header u-size100-p u-imagenFondo u-textCenter">   
            ...
            <h1 class="Header-Logo u-inline-block slideDown"><span class="u-ocultar">Enermar. BUNKERING SERVICES |</span></h1>
            ...
            <div class="Header-video"><a id="mostrarPublicidad" href="video.html" class="u-ocultar u-inline-block fancyboxPublicidad fancybox.iframe Video-Watch">WATCH VIDEO</a></div>
            ...
            <div class="Header-Barra u-size100-p fadeIn2">
            	<div class="Header-Center u-size-center u-textLeft">
                    ...
                    <p class="Header-colClima">The price changes according to the price of the dollar exchange rate.</p>
                  <!--  <p class="Header-colClima u-inline-block">
                    ...
                    <p class="Header-colPuesto u-floatRight">
                        ...
                        PUERTO:
                        <span class="Header-Azul"><?php if(strcmp($estado,"Abierto")==0) echo "Open"; else echo "Closed"; ?></span>
                    </p>-->
            	</div>
            </div>
        </header>
        ...
        <section class="About u-size100-p u-imagenFondo">
        	...
        	<article class="About-Center u-size-center u-desaparecer aparecerUp">
                ...
                <p class="About-Ibia"><strong>We are members of <a href="http://ibia.net/" target="_blank">ibia.net</strong></a></p> 
                <figure class="About-ImgIbia">
                	 <a href="http://ibia.net/" target="_blank"><img class="u-efecto" src="images/ibia.png" alt="Ibia" /></a>
                </figure>   
            </article>
        </section>
        ...
        <section class="EstamosServirle u-size100-p u-imagenFondo">
        	<article class="EstamosServirle-Center u-size-center">
                ...
                <footer class="Footer u-textCenter">
                    &copy;  2015. Enermar Burkering Services. All rights reserved. Design and development by <a href="http://www.gomultimedios.com/" target="_blank">GO multimedios.</a>        
                </footer>
            </article>
        </section>
        ...
        <a id="mostrarPublicidad" href="video.html" class="u-ocultar u-inline-block fancyboxPublicidad fancybox.iframe"></a>                
    </body>
</html>
