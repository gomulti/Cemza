    ...
    <body>		
        ...
        <nav class="MainMenu u-size100-p u-textCenter">
            ...
            <ul class="MainMenu-List u-textLeft u-mayuscula">
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Header">Home</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Precios-Title">Currrent Prices</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Nosotros">About us</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="QueOfrecemos-Center">What we offer</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="AlcanceOperativo-Center">Operational scope</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="NuestrosServicios-Title">Our services</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Acreditaciones-Center">Accreditations</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Contacto">Contact us</a>
                </li>
            </ul>

            <a href="../index.php" class="HeaderMenu-Idioma HeaderMenu-Idioma--MainMenu u-inline-block u-redondeadoTotal"></a>
        ...
        <header class="Header u-imagenFondoCover u-size100-p u-textCenter fadeIn">
            ...
            <div class="HeaderMenu u-size100-p u-textCenter u-positionAbsolute u-desaparecer">
                ...
                <ul class="HeaderMenu-List u-textLeft u-mayuscula">
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Header">Home</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Precios-Title">Current Prices</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Nosotros">About us</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="QueOfrecemos-Center">What we offer</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="AlcanceOperativo-Center">Operational scope</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="NuestrosServicios-Title">Services</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Acreditaciones-Center">Accreditations</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Contacto">Contact us</a>
                    </li>
                </ul>

                <a href="../index.php" class="HeaderMenu-Idioma u-inline-block u-redondeadoTotal"></a>
        ...
        <section class="Precios u-imagenFondoCover u-size100-p u-textCenter">
        	<article class="Precios-Center u-inline-block">
                ...
                <p class="u-desaparecer aparecerSlideUp">Price by liter / <strong>$<?php echo $custom_fields['Precio-por-litro'][0]; ?> MXN</strong></p>
                
                <p class="u-desaparecer aparecerSlideUp" style="margin-top: 10px;">* Exchange rate: <strong>$<?php echo $custom_fields['Tipo-cambio'][0]; ?> MXN</strong></p>
        ...
        <div class="BgFondo3 u-size100-p u-imagenFondoCover">
             ...
             <section class="QueOfrecemos u-imagenFondoCover u-size100-p u-textCenter">
	        	<article class="QueOfrecemos-Center u-inline-block">
					<h3 class="QueOfrecemos-Title u-inline-block u-desaparecer aparecerSlideUp">WHAT WE OFFER <span class="u-inline-block"></span></h3>
                    ...
                    <ul class="QueOfrecemos-List u-textLeft">
                        ...
                        <?php
                            ...
                            query_posts('category_name=que-ofrecemos-en&order=ASC');				
        ...
        <div class="BgFondo4 u-size100-p u-imagenFondoCover">
            <section class="NuestrosServicios u-size100-p u-textCenter">
                ...
                <article class="NuestrosServicios-Center u-inline-block">
                    ...
                    <h5 class="NuestrosServicios-TitleME u-mayuscula">
                        Methods of delivery 
                    </h5>
		...
		<footer class="Footer u-size100-p">
                ...
                <div class="Contacto-Center u-inline-block">
                    ...
                    <div class="u-textLeft">
                        ...
                        <form class="Contacto-Formulario u-inline-block u-floatRight" name="Contacto-FmFormulario" id="Contacto-FmFormulario" method="post" action="">                	
                            ...
                            <div class="Contacto-Msj u-textCenter fadeIn2"><strong class="u-mayuscula u-inline-block">Thanks for contact us!.</strong><br> Your message was sent successfully.</div>
                        </form>
                    </div>
            ...
            <div class="DerechoAutor u-size100-p u-textCenter">
                <div class="DerechoAutor-Center u-inline-block u-textLeft">
                    ...
                    <p class="u-inline-block u-floatRight"><a href="http://www.cemza.com/CGI-BIN/CemzaAvisoPrivacidad.html">Privacy Policy</a><span class="spacer">..........</span>
                        &copy; 2018. All rights reserved. Design and development by <a href="http://gom360.mx/" target="_blank">GO multimedios.</a> 
                    </p>
                </div>
            </div>
        </footer>
