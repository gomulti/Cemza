<?php
 ...
 try 
 {
	...
	$mail->CharSet = 'utf-8';         
  $mail->AddAddress($destino, 'Correo de contacto - Sitio de Cemza');
	$mail->SetFrom($correo, $correo);
	$mail->Subject = 'Correo de contacto - Sitio de Cemza';
	...
	$mail->MsgHTML('                  
                    ...
                    <title>Correo de contacto - Sitio de Cemza</title>
                    <style type="text/css">
                        body{
                            line-height: normal;
                            color:#333333;
                    ...
                    <tr>
					<tr>
                    	<td height="86"><strong>Mensaje:</strong></td>
                      	<td>'.$mensaje.'</td>
                    </tr>
                    </table>
                    </body>
