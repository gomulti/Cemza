    ...
    <body>		
        <nav class="MainMenu u-size100-p u-textCenter">
            ...
            <ul class="MainMenu-List u-textLeft u-mayuscula">
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Nosotros">Acerca de</a>
                </li>
                <li class="u-inline-block">
                ...
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Certificaciones">Certificación</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block" data-menu="Reclutamiento">Bolsa de Trabajo</a>
                </li>
                <li class="u-inline-block">
                    <a class="MainMenu-ItemList u-inline-block u-sinMargen" data-menu="Contacto">Contáctanos</a>
                </li>
            </ul>

            <div class="MainMenu-Idioma u-inline-block u-redondeadoTotal u-efecto">
                <a href="en/" class="u-inline-block u-positionAbsolute">Ingles</a>
            </div>
    	...
    	<header class="Header u-size100-p u-textCenter">
            ...
            <div class="HeaderMenu u-size100-p u-textCenter u-positionAbsolute u-desaparecer">
                <ul class="HeaderMenu-List u-textLeft u-mayuscula">
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Nosotros">Acerca de</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Servicios">Servicios</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Productos">Productos</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Certificaciones">Certificación</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block" data-menu="Reclutamiento">Bolsa de Trabajo</a>
                    </li>
                    <li class="u-inline-block">
                        <a class="HeaderMenu-ItemList u-inline-block u-sinMargen" data-menu="Contacto">Contáctanos</a>
                    </li>
                </ul>
        ...
        <section class="Nosotros u-imagenFondoCover u-size100-p u-textCenter">
        	<article class="Nosotros-Center u-inline-block u-textLeft">
                ...
                <ul class="Nosotros-List u-desaparecer aparecerSlideUp">
                    <?php
                        query_posts('category_name=acerca-de-nosotros&order=ASC');				
                ...
                <ul class="Servicios-List u-desaparecer aparecerSlideUp">
                    <li class="u-inline-block">
                        <a class="Servicios-ItemList u-inline-block activo">
                            ...
                            <h4 class="Servicios-TitleItemList Servicios-TitleItemList--Reclutamiento u-inline-block">Reclutamiento y Selección de personal</h4>
                        </a>
                        ...
                        <a class="Servicios-ItemList Servicios-ItemList--C2 u-inline-block">
                            ...
                            <h4 class="Servicios-TitleItemList u-inline-block u-redondeadoTotal">Contratación, pago de nómina, impuestos, prestaciones y otros</h4>
                        </a>
                        <div class="Servicios-InfoListR u-imagenFondoCover"></div>
                    </li><li class="u-inline-block">
                        <a class="Servicios-ItemList u-inline-block">
                            ...
                            <h4 class="Servicios-TitleItemList u-inline-block u-redondeadoTotal">Cursos y Certificaciones con alianzas estratégicas</h4>
                        </a>
                        <div class="Servicios-InfoListR u-imagenFondoCover"></div>
                    </li><li class="u-inline-block">
                        <a class="Servicios-ItemList Servicios-ItemList--C2 u-inline-block">
                            ...
                            <h4 class="Servicios-TitleItemList Logistica u-inline-block u-redondeadoTotal">Logística de Personal</h4>
                        </a>
                        <div class="Servicios-InfoListR u-imagenFondoCover"></div>
                    </li>
                </ul>
        ...
        <section class="Productos u-size100-p u-imagenFondoCover u-textCenter">
            <article class="Productos-Center u-inline-block">
                <div class="Productos-Content u-floatRight u-textLeft">
                    ...
                    <?php
                        query_posts('category_name=productos&order=ASC');				
                    ...
                    <p class="Productos-TxtDescarga u-textCenter u-desaparecer aparecerSlideUp"><strong>Descarga nuestro catálogo de productos (PDF 16.4 MB.)</strong></p>

                    <a href="catalogo/catalogo_presco_offshore.pdf" class="Productos-BtnDescarga u-block u-redondeado u-desaparecer aparecerSlideUp" target="_blank">Descargar</a>
                </div>
            </article>
        </section>
            ...
            <article class="Certificaciones-Center u-inline-block">
                ...
                <ul class="Certificaciones-List u-inline-block">
                    <?php
                        ...
                        query_posts('category_name=certificaciones&order=ASC');				
        ...
        <section class="Reclutamiento u-size100-p u-imagenFondoCover u-textCenter">
            <article class="Reclutamiento-Center u-inline-block">
                ...
                <a class="Reclutamiento-Btn u-inline-block u-redondeado u-textLeft" href="https://presco.hiringroom.com/jobs" target="_blank">Ver bolsa de trabajo</a>
                <?php
                    endwhile;
                    wp_reset_query();
                ?>
