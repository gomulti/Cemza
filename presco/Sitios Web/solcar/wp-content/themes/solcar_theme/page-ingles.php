            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav text-uppercase">
                        <li><a href="#about" class="navTo xx">about us</a></li>
                        <li><a href="#service" class="navTo xx">our services</a></li>
                        <li><a href="#products" class="navTo xx">products</a></li>
                        <li><a href="#contact" class="navTo xx">contact us</a></li>
                    </ul>
                        ...
                        <span class="box_idioma cambio" > 
                            <span  class="dropdown">
                                <span id="dLabel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img  class="i-round img-circle" src="<?php bloginfo('template_url') ?>/imgs/ico-idioma.png" alt="idiomas" data-toggle="tooltip" data-placement="bottom" title="Cambiar idioma">
                                </span>
                                <ul class="dropdown-menu" aria-labelledby="dLabel">
                                    <li><a href="http://solcar.gomserver.net"> <img src="<?php bloginfo('template_url') ?>/imgs/ico-idioma-mx.png" alt=""> Spanish</a></li>
                                </ul>
                            </span>
                        </span>
                    </ul>
                ...
                <div class="text-center">
                    <span class="box_idioma cambio" > 
                        <span  class="dropdown">
                            <span class="wow fadeIn" id="dLabel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="i-round" src="<?php bloginfo('template_url') ?>/imgs/ico-idioma.png" alt="idiomas" data-toggle="tooltip" data-placement="bottom" title="Cambiar idioma">
                            </span>
                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                <li><a href="http://solcar.gomserver.net"> <img src="<?php bloginfo('template_url') ?>/imgs/ico-idioma-mx.png" alt=""> Spanish</a></li>
                    ...
                    <nav class="nav_home wow fadeInUp">
                        <ul class="text-uppercase">
                            <li><a href="#about" class="navTo cambio xx">about us</a></li>
                            <li><a href="#service" class="navTo cambio xx">our services</a></li>
                            <li><a href="#products" class="navTo cambio xx">products</a></li>
                            <li><a href="#contact" class="navTo cambio xx">contact us</a></li>
                        </ul>
                    </nav>
                    <div class="box_foot row">
                        <div class="container">
                            ...
                            <div class="col-xs-9 text-right wow fadeInRight">
                                <small class="pull-right">© 2018. All rights reserved. Design and development by GO multimedios.</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 mtop wow fadeInUp">
                        <?php query_posts('category_name=about-us&showposts=1'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                        ...
                        <div class="box_post_note">
                            ...
                            <div class="note info">
                                <?php query_posts('category_name=about-us-extract&showposts=1'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>    
                                    <?php the_content();?>
                                <?php endwhile; else: ?>
                                    <h5>¡Lo sentimos, aun no tenemos notas aquí!</h5>
                                <?php endif; wp_reset_query(); ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 mtop wow slideInLeft">
                        <?php query_posts('category_name=our-services&showposts=1'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                        <h1 class="ttl_sections">Our services</h1>
                        ...
                        <div class="box_oferta">
                            <br>
                            <h4>Our value offer includes:</h4>
                            <?php query_posts('category_name=offer-values&showposts=1'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                            <?php the_content(); ?>  
                            <?php endwhile; else: ?>
                            <h5>¡Lo sentimos, aun no tenemos notas aquí!</h5>
                        <?php endif; wp_reset_query(); ?>  
            ...
            <div class="container">
                <div class="row mtop wrapper_products_ttl fadeInDown wow">
                    <div class="col-xs-4 col-sm-7">
                        <h1 class="ttl_sections">Products</h1> 
                    </div>
                    <div class="col-xs-7 col-sm-5 box_download">
                        <div class="row">
                            <div class="col-xs-6 text-dwl">Download our product catalog (PDF 4.5 MB.)</div>
                            <div class="col-xs-6">
                                <a class="btn_download btns" download="Documento APM" href="<?php bloginfo('template_url') ?>/imgs/bg_home_a.png"> Download  <span class="ico glyphicon glyphicon-download-alt" aria-hidden="true"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                <?php query_posts('category_name=products&showposts=4&order=ASC'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>    
        ...
        <section id="contact" class="wrapper_contact page ">
            ...
            <div class="container">
                <div class="row mtop">
                    ...
                    <?php query_posts('category_name=contact-us&tag=contacto-info&showposts=1'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>   
                        <h1 class="ttl_sections"><?php the_title();?></h1>
                        <div class="p_text">
                        <?php the_content();?>
                        </div>
                ...
                <div class="row wpr_contact_form">
                    ...
                    <form class="form_contact" method="POST" data-toggle="validator" role="form" id="formulario_solcar">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="2" name="mensaje" id="mensaje" placeholder="Message"></textarea>
                            </div>
                            
                                <button type="submit" class="cambio btn_summit btns" value="Enviar"><span>Send</span> <span class="ico glyphicon glyphicon-send" aria-hidden="true"></span></button>
                        </form>
                    </div>
                </div>
            </div>
