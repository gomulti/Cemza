			$(document).ready(function(){
				...
				setTimeout(function(){
					$(".Header-Linea").animate({width: "209px"},800);
				},1600);

				setTimeout(function(){
					$(".HeaderMenu").addClass("slideLeft");
					$(".Nosotros-Center p").addClass("u-desaparecer aparecerSlideUp");
					$(".Descarga p").addClass("u-desaparecer aparecerSlideUp");
					
					//$('.wp-block-gallery li').attr("","");

					$('.wp-block-gallery li').each(function(j) {
						$('.wp-block-gallery li img').eq(j).attr("srcset","");	
						$('.wp-block-gallery li img').eq(j).attr("sizes","");	
						$('.wp-block-gallery li').eq(j).attr("data-thumb",$('.wp-block-gallery li img').eq(j).attr("src"));	
					});

					$('.wp-block-gallery').lightSlider({
						gallery:true,
						autoWidth:true,
						item:1,
						thumbItem:7,
						...
						onSliderLoad: function() {
							$('.wp-block-gallery').removeClass('cS-hidden');
						}
					});
