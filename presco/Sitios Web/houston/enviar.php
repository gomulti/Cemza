<?php
 ...
 $headers = "From: Presco - Houston";
 $headers .= "<".$email.">\r\n";
 $headers .= "Reply-To: ".$email."\nContent-Type: text/html; charset=iso-8859-1"; 
	
 $message = "<p><b>Nombre: </b>".$nombre."</p><p><b>Email:</b> ".$email."</p><p><b>Teléfono: </b>".$telefono."</p><p><b>Mensaje: </b>".$comentario."</p>";
	 
 $ban = mail($destino,"Correo de contacto - Sitio de Presco houston", $message, $headers);
