    ...
    <body>		
    	<nav class="MainNav u-size100-p u-textCenter slideDown">
        	<div class="MainNav-Center u-inline-block u-textLeft">
                ...
                <a href="en/" class="MainNav-Idioma u-redondeadoTotal u-inline-block"></a>
            </div>
        </nav>
        ...
        <section class="Servicios u-size100-p u-textCenter">            
            <h4 class="Servicios-Title u-imagenFondoCover">
                <span class="u-desaparecer aparecerFadeIn">
                    <?php
                        query_posts('category_name=nuestros-servicios&order=ASC&showposts=1');				
            ...
            <ul class="Servicios-List u-textLeft">
                ...
                <?php
                    $j=0;
                    $listClass = array("Servicioa-IcoPerforacion", "Servicioa-IcoServicios", "Servicioa-IcoFluidos","Servicioa-IcoCementaciones","Servicioa-IcoRegistros","Servicioa-IcoHerramientas","Servicioa-IcoEmpacadores","Servicioa-IcoPruebas","Servicioa-IcoBarcoLlamado","Servicioa-IcoCorteRecuperacion","Servicioa-IcoCorteFlama","Servicioa-IcoMantenimientoArboles");
        	...
        	<article class="ServiciosAdicionales-Center u-inline-block">
                ...
                <div class="ServiciosAdicionales-Info u-textLeft u-desaparecer aparecerFadeIn">
                    ...
                    <h5 class="ServiciosAdicionales-Title  u-textCenter">
                        <?php
                            query_posts('category_name=servicios-adicionales&order=ASC&showposts=1');				
                    ...
                    <?php
                        query_posts('category_name=servicios-adicionales&order=ASC');			
        ...
        <footer class="Footer u-size100-p u-textCenter">
        	...
        	<div class="Footer-Center u-inline-block u-textLeft">
                ...
                <p class="Footer-Txt u-floatRight">
                    <a class="Footer--Politica" href="http://www.cemza.com/CGI-BIN/CemzaAvisoPrivacidad.html" target="_blank">Política de Privacidad</a> &copy; 2018. Todos los derechos reservados. Diseño y desarrollo por <a href="http://gomultimedios.com/" target="_blank">GO multimedios</a>.
                </p>
            </div>
        </footer>
    </body>
