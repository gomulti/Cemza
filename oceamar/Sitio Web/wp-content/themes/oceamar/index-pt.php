	  	...
	  	<div class="container-fluid">
		    	...
		    	<span class="btn_idioma_mvl visible-xs" > 
		        	<span  class="dropdown">
		        		<span id="dLabel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						    <img src="<?php bloginfo('template_url') ?>/imgs/ico-idioma-pt.png" alt="idiomas" data-toggle="tooltip" data-placement="bottom" title="Mudar de idioma">
						    <span class="caret"></span>
						</span>
						<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel">
						    <li><a href="http://oceamar.com.mx/ingles/"> <img src="<?php bloginfo('template_url') ?>/imgs/ico-idioma.png" alt=""> Inglês</a></li>
						     <li role="separator" class="divider"></li>
						    <li><a href="http://oceamar.com.mx/"> <img src="<?php bloginfo('template_url') ?>/imgs/ico-idioma-mx.png" alt=""> Espanhol</a></li>
						</ul>
		        	</span>
		        </span>
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			    <ul class="nav navbar-nav nav_a cambio">
			        <li><a class="transicion cambio" href="#us">SOBRE OCEAMAR </a></li>
			        <li><a class="transicion cambio" href="#service">SERVIÇOS </a></li>
			        <li><a class="transicion cambio" href="#client">NOSSOS CLIENTES </a></li>
			        <li><a class="transicion cambio" href="#contact">CONTATO </a></li>
			    </ul>

			    <div class="nav navbar-nav navbar-right btns_ico">
			    	<a class="cambio" href="https://www.facebook.com/Oceamar-Offshore-Agency-214311189152875/" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Facebook"><img src="<?php bloginfo('template_url') ?>/imgs/ico-fb.png" alt=""> </a>
			        <a class="cambio" href="https://www.instagram.com/oceamar_agency/" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Instagram "><img src="<?php bloginfo('template_url') ?>/imgs/ico-instag.png" alt=""> </a>
			        <a class="cambio" href="https://www.linkedin.com/company/10546640/admin/updates/" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Linkedin"><img src="<?php bloginfo('template_url') ?>/imgs/ico-in.png" alt=""> </a></li>
...
<section id="home" class="sec_home flex_container">
	<div class="container">
		...
		<div class="col-xs-6 box_info extra wow fadeInRight">
			<?php query_posts('category_name=acerca&tag=version-portugues&showposts=1'); if (have_posts()) : while (have_posts()) : the_post(); ?>
				<?php the_content(); ?>
			<?php endwhile; else: ?>
...
<section id="us" class="sec_us">
	<div class="ttl_sec">
		<div class="container wow slideInUp">
			<?php query_posts('category_name=nosotros&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
			<h1><?php the_title(); ?></h1> 
			<?php the_content(); ?> 
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-xs-6 fadeInLeft wow">
					<?php query_posts('category_name=vision&tag=version-portugues&showposts=1');
				...
				<div class="col-xs-6 wow fadeInRight">
					<?php query_posts('category_name=mision&tag=version-portugues&showposts=1'); 
					if(have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<div class="row">
				<div class="wrapper_values">
					...
					<?php query_posts('category_name=valores&tag=version-portugues&showposts=5'); if(have_posts()) : while (have_posts()) : the_post(); ?>
...
<section id="service" class="sec_service">
	<div class="ttl_sec">
		<div class="container wow slideInUp">
			<?php query_posts('category_name=servicios&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
			<h1><?php the_title(); ?></h1> 
			<?php the_content(); ?> 
			...
			<div class="row">
				<div class="wrapper_box_service">
					<div class="content_box wow fadeInUp">
						<div class="card cardex">
							...
							<?php query_posts('category_name=agenciamiento&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
					...
					<div class="content_box wow fadeInUp">
						<div class="card cardex">
							<?php query_posts('category_name=tramites&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
					        <div class="front">
								<?php if (has_post_thumbnail() ) { the_post_thumbnail();} ?>
					...
					<div class="">
						<div class="doble">
							<div class="content_box wow fadeInUp">
								<div class="card cardex">
									<?php query_posts('category_name=logistica&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
							        <div class="front">
										<?php if (has_post_thumbnail() ) { the_post_thumbnail();} ?>
										<h3 class="name_service"><?php the_title(); ?></h3>
							        </div>
					 ...
					 --><div class="doble ">
					 		<div class="content_box wow fadeInUp">
								<div class="card cardex">
									<?php query_posts('category_name=importación-exportación&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
							        <div class="front">
										<?php if (has_post_thumbnail() ) { the_post_thumbnail();} ?>
			 ...
			 --><div class="wrapper_box_service">
			 		<div class="doble">
			 			<div class="content_box wow fadeInUp">
							<div class="card cardex">
								<?php query_posts('category_name=personal&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
						        <div class="front">
			 	 ...
			 	 --><div class="doble">
			 			<div class="content_box ">
							<div class="card cardex cc wow fadeInUp">
								<?php query_posts('category_name=shorebase&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
						        <div class="front">
									<?php if (has_post_thumbnail() ) { the_post_thumbnail();} ?>
						...
						<div class="content_box ">
							<div class="card cardex cc wow fadeInUp">
								<?php query_posts('category_name=servicios-portuarios&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
						        <div class="front">
									<?php if (has_post_thumbnail() ) { the_post_thumbnail();} ?>
					...
					<div class="content_box wow fadeInUp">
						<div class="card cardex">
							<?php query_posts('category_name=renta-equipos&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
					        <div class="front">
	...
	<div class="puertos">
		<div class="wrapper_puertos">
			<div class="container">
				<h3 class="ttl_puertos wow fadeInDown">Nós operamos nos principais portos do Golfo do México:</h3>
...
<section id="client" class="sec_client">
	<div class="container">
		...
		<div class="wrapper_lgs_client text-center wow fadeInUp">
			<div class="row">
				<?php query_posts('category_name=clientes&tag=version-portugues&showposts=13'); if(have_posts()) : while (have_posts()): the_post(); ?>
...
<section id="contact" class="sec_contact">
	<div class="container">
		<div class="row">
			<?php query_posts('category_name=contacto&tag=version-portugues&showposts=1'); if(have_posts()) : while (have_posts()): the_post(); ?>
			...
			<div class="col-xs-4 wow fadeInLeft info_text">
				...
				<form>
					<div class="form-group">
					    <input type="text" class="form-control" id="" required="" placeholder="Nome">
					</div>
					<div class="form-group">
					    <input type="email" class="form-control" id="" required="" placeholder="Email">
					</div>
					<div class="form-group">
					   <textarea class="form-control" rows="1" required="" placeholder="Comentários"></textarea>
					</div>
					
				  	<button type="submit" class="btn "><span>Enviar</span> <span class="glyphicon glyphicon-send" aria-hidden="true"></span></button>
				</form>
			</div>
...
<footer>
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-6 f_info text-center  wow fadeInUp">© 2018. Todos os direitos reservados. Design e desenvolvimento por <a href="http://gomultimedios.com/" target="_blank"> GO miltimedios.</a></small></div>
		</div>
	</div>
</footer>
